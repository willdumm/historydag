...
class HistoryDagNode:
    ...
    def _get_trees(
        ...
        Args:
            min_weight: whether to iterate through only minimum weight trees.
            kwargs: keyword arguments for :meth:`trim_optimal_weight`."""

        if min_weight:
            dag = self.copy().trim_optimal_weight(**kwargs)
        else:
            dag = self
